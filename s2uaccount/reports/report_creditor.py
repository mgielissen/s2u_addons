...
class AccountReportCreditor(models.TransientModel):
    _name = "report.s2uaccount.creditor"
    _description = "Creditor Report"
    ...
    def _print_report(self, data):
        return self.env.ref('s2uaccount.s2uaccount_report_creditor').\
